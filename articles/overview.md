...
```
    ...
    ## [25] desc_1.4.3          bslib_0.12.0        GiottoUtils_0.2.5  
    ## [28] rlang_1.3.0         cachem_1.1.0        terra_1.9-46       
    ## [31] xfun_0.60           fs_2.1.0            sass_0.4.10        
    ## [34] otel_0.2.0          cli_3.6.6           withr_3.0.3        
    ## [37] pkgdown_2.2.1       magrittr_2.0.5      digest_0.6.39      
    ## [40] grid_4.6.1          rappdirs_0.3.4      lifecycle_1.0.5    
    ## [43] S4Vectors_0.50.1    evaluate_1.0.5      data.table_1.18.6.1
    ## [46] codetools_0.2-20    ragg_1.5.2          stats4_4.6.1       
