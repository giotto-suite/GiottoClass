...
```
    ...
    ## Setting spatial network [aggregate] Delaunay_network

    ## > " kNN_network " already exists and will be replaced with new
    ##  spatial network

    ## Setting spatial network [aggregate] kNN_network
