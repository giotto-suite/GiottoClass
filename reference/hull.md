...
Compute a hull around Giotto spatial object or terra SpatVector. The
concaveness of the concave hull can be specified in different ways.
...
- x:
  ...
  any of giotto image, giottoPolygon, giottoPoints, spatLocsObj,
  SpatVector
...
- ...:
  ...
  [`terra::hull`](https://rspatial.github.io/terra/reference/convhull.html)

  `type`

  :   character. One of "convex", "rectangle", "circle",
